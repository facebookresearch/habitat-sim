...
PBRShader::PBRShader(Flags flags, Magnum::UnsignedInt lightCount) {
...
/*
PBRShader& PBRShader::bindAtlasTexture(Mn::GL::Texture2D& texture) {
  texture.bind(TextureBindingPointIndex::atlas);
  return *this;
}

PBRShader& PBRShader::bindAdjFacesBufferTexture(
...
PBRShader& PBRShader::setExposure(float exposure) {
...
PBRShader& PBRShader::setSaturation(float saturation) {
  setUniform(saturationUniform_, saturation);
  return *this;
}

PBRShader& PBRShader::setAtlasTextureSize(Mn::GL::Texture2D& texture,
                                                    uint32_t tileSize) {
