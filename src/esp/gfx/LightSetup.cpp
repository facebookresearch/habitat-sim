...
LightSetup getDefaultLights() {
  ...
  // scenes
  Magnum::Color3 rgb_hue = {1.0, 1.0, 1.0}; // {0.7, 0.7, 0.92};
  ...
  return LightSetup{
      ...
      {{0.0, -0.3, -0.4, 0.0}, color, LightPositionModel::Global},  // -z
      {{0.0, -0.3, 0.6, 0.0}, color, LightPositionModel::Global},   // +z
      {{-0.4, -0.3, 0.0, 0.0}, color, LightPositionModel::Global},  // -x
      {{0.6, -0.3, 0.0, 0.0}, color, LightPositionModel::Global},   // +x
