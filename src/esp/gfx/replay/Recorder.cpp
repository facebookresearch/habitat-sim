...
void Recorder::onCreateRenderAssetInstance(
  ...
  // Reference code for including the root node scale in the creation scale. This seems
  // to be incorrect/unnecessary, so it is currently commented out. We don't remember
  // the legacy reason for this code.
