...
class VoxelGrid {
 ...
 public:
  ...
  /**
   * @brief Loads a voxel grid from a file
   * @param filepath The file path to the saved voxel grid (.svx file format).
   */
  ...
  bool saveGridToSVXFile(const std::string& gridName,
    ...
    auto arrayView = grids_[gridName].view;
