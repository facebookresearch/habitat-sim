...
AbstractPrimitiveAttributes::ptr AssetAttributesManager::createObject(
  ...
  return this->postCreateRegister(std::move(primAssetAttributes), registerTemplate);
...
int AssetAttributesManager::registerObjectFinalize(
  ...
  int primTemplateID =
      this->addObjectToLibrary(std::move(primAttributesTemplate), primAttributesHandle);
