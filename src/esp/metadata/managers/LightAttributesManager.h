...
class LightAttributesManager
    : public AttributesManager<Attrs::LightAttributes> {
 public:
  LightAttributesManager()
      : AttributesManager<Attrs::LightAttributes>::AttributesManager(
            "Light",
   ...
   */
  Attrs::LightAttributes::ptr createObject(
   ...
   */
  void setValsFromJSONDoc(Attrs::LightAttributes::ptr lightAttribs,
 ...
 protected:
   ...
   */
  Attrs::LightAttributes::ptr initNewObjectInternal(
  ...
  int registerObjectFinalize(
      Attrs::LightAttributes::ptr lightAttributesTemplate,
  ...
  void buildCtorFuncPtrMaps() override {
    this->copyConstructorMap_["LightAttributes"] =
        &LightAttributesManager::createObjectCopy<Attrs::LightAttributes>;
