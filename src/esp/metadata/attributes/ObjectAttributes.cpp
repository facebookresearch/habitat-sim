...
std::string AbstractObjectAttributes::getObjectInfoInternal() const {
  return getRenderAssetHandle()
      ...
      .append(1, ',')
      .append(getVec3AsString("scale"))
      .append(1, ',')
      .append(std::to_string(getMargin()))
      .append(1, ',')
      .append(getVec3AsString("orient_up"))
      .append(1, ',')
      .append(getVec3AsString("orient_front"))
      .append(1, ',')
...
std::string ObjectAttributes::getAbstractObjectInfoInternal() const {
  return std::to_string(getMass())
      .append(1, ',')
      .append(getVec3AsString("COM"))
      .append(1, ',')
      .append(getVec3AsString("inertia"))
      .append(1, ',')
