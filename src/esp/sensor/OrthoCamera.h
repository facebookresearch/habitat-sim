...
#ifndef ESP_SENSOR_ORTHOCAMERA_H_
#define ESP_SENSOR_ORTHOCAMERA_H_
...
class OrthoCamera : public VisualSensor {
 public:
  // constructor: the status of the ortho camera is "valid" after
  // construction;
  // user can use them immediately
  explicit OrthoCamera(scene::SceneNode& orthoCameraNode,
  ...
  virtual OrthoCamera& setProjectionMatrix(
      gfx::RenderCamera& targetCamera) override;
  // set the transformation matrix to the given render camera
  virtual OrthoCamera& setTransformationMatrix(
      gfx::RenderCamera& targetCamera) override;
  // set the view port to the given render camera
  virtual OrthoCamera& setViewport(gfx::RenderCamera& targetCamera) override;
...
#endif  // ESP_SENSOR_ORTHOCAMERA_H_
