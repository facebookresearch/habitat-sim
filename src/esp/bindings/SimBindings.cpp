...
void initSimBindings(py::module& m) {
  ...
  py::class_<Simulator, Simulator::ptr>(m, "Simulator")
      ...
      .def("update_rendering_from_physics",
           &Simulator::updateRenderingFromPhysics, "force"_a = true)
