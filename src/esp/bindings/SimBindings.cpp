  ...
  py::
      class_<Simulator, Simulator::ptr>(m, "Simulator")
        ...
        .. note-warning::
          ...
          .def(
              "voxelize_scene", &Simulator::createSceneVoxelization,
              "resolution"_a,
              R"(Generates a scene voxelization with a specified resolution, where resolution is approximately the number of voxels.)")
#endif
          .def(
              "set_object_voxelization_draw",
              &Simulator::setObjectVoxelizationDraw, "draw_voxels"_a,
              "object_id"_a, "grid_name"_a = "Boundary",
              R"(Generates a scene voxelization with a specified resolution, where resolution is approximately the number of voxels.)")
          .def(
              "set_scene_voxelization_draw",
