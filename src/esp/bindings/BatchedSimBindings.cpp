...
py::capsule getDebugColorMemory(BatchedSimulator& bsim,
...
void initBatchedSimBindings(py::module& m) {
  ...
  py::class_<EpisodeGeneratorConfig, EpisodeGeneratorConfig::ptr>(
      ...
      .def_readwrite("num_stage_variations",
                     &EpisodeGeneratorConfig::numStageVariations, R"(Todo)")
      .def_readwrite("num_object_variations",
                     &EpisodeGeneratorConfig::numObjectVariations, R"(Todo)")
      .def_readwrite("min_nontarget_objects",
  ...
  py::class_<BatchedSimulatorConfig, BatchedSimulatorConfig::ptr>(
      ...
      .def_readwrite("include_depth", &BatchedSimulatorConfig::includeDepth,
                     R"(Todo)")
      .def_readwrite("include_color", &BatchedSimulatorConfig::includeColor,
                     R"(Todo)")
      .def_readwrite("sensor0", &BatchedSimulatorConfig::sensor0, R"(Todo)")
      .def_readwrite("num_debug_envs", &BatchedSimulatorConfig::numDebugEnvs,
                     R"(Todo)")
      .def_readwrite("debug_sensor", &BatchedSimulatorConfig::debugSensor,
                     R"(Todo)")
      .def_readwrite("force_random_actions",
                     &BatchedSimulatorConfig::forceRandomActions, R"(Todo)")
      .def_readwrite("do_async_physics_step",
                     &BatchedSimulatorConfig::doAsyncPhysicsStep, R"(Todo)")
      .def_readwrite("num_physics_substeps",
                     &BatchedSimulatorConfig::numSubsteps, R"(Todo)")
      .def_readwrite("enable_robot_collision",
                     &BatchedSimulatorConfig::enableRobotCollision, R"(Todo)")
      .def_readwrite("enable_held_object_collision",
                     &BatchedSimulatorConfig::enableHeldObjectCollision,
                     R"(Todo)")
      .def_readwrite("do_procedural_episode_set",
                     &BatchedSimulatorConfig::doProceduralEpisodeSet, R"(Todo)")
      .def_readwrite("episode_generator_config",
                     &BatchedSimulatorConfig::episodeGeneratorConfig, R"(Todo)")
      .def_readwrite("episode_set_filepath",
                     &BatchedSimulatorConfig::episodeSetFilepath, R"(Todo)")
      .def_readwrite("enable_sliding", &BatchedSimulatorConfig::enableSliding,
                     R"(Todo)")
      .def_readwrite("slide_max_steps", &BatchedSimulatorConfig::slideMaxSteps,
                     R"(Todo)")
      .def_readwrite("slide_step_size", &BatchedSimulatorConfig::slideStepSize,
                     R"(Todo)");
  ...
  py::class_<PythonEnvironmentState, PythonEnvironmentState::ptr>(
      ...
      .def_readwrite("episode_step_idx",
                     &PythonEnvironmentState::episode_step_idx, R"(Todo)")
      .def_readwrite("target_obj_idx", &PythonEnvironmentState::target_obj_idx,
                     R"(Todo)")
      .def_readwrite("target_obj_start_pos",
                     &PythonEnvironmentState::target_obj_start_pos, R"(Todo)")
      .def_readwrite("robot_start_pos",
                     &PythonEnvironmentState::robot_start_pos, R"(Todo)")
      .def_readwrite("robot_start_rotation",
                     &PythonEnvironmentState::robot_start_rotation, R"(Todo)")
      .def_readwrite("goal_pos", &PythonEnvironmentState::goal_pos, R"(Todo)")
      .def_readwrite("goal_rotation", &PythonEnvironmentState::goal_rotation,
                     R"(Todo)")
      .def_readwrite("robot_pos", &PythonEnvironmentState::robot_pos, R"(Todo)")
      .def_readwrite("robot_rotation", &PythonEnvironmentState::robot_rotation,
                     R"(Todo)")
      .def_readwrite("robot_joint_positions",
                     &PythonEnvironmentState::robot_joint_positions, R"(Todo)")
      .def_readwrite("robot_joint_positions_normalized",
                     &PythonEnvironmentState::robot_joint_positions_normalized,
                     R"(Todo)")
      .def_readwrite("ee_pos", &PythonEnvironmentState::ee_pos, R"(Todo)")
      .def_readwrite("ee_rotation", &PythonEnvironmentState::ee_rotation,
                     R"(Todo)")
      .def_readwrite("did_collide", &PythonEnvironmentState::did_collide,
                     R"(Todo)")
      .def_readwrite("held_obj_idx", &PythonEnvironmentState::held_obj_idx,
                     R"(Todo)")
      .def_readwrite("did_attempt_grasp",
                     &PythonEnvironmentState::did_attempt_grasp, R"(Todo)")
      ...
      .def_readwrite("drop_height", &PythonEnvironmentState::drop_height,
                     R"(Todo)")
      .def_readwrite("obj_positions", &PythonEnvironmentState::obj_positions,
                     R"(Todo)")
      .def_readwrite("obj_rotations", &PythonEnvironmentState::obj_rotations,
                     R"(Todo)");
  ...
  py::class_<BatchedSimulator, BatchedSimulator::ptr>(m, "BatchedSimulator")
      ...
      .def("get_num_episodes", &BatchedSimulator::getNumEpisodes, R"(todo)")
      .def("get_num_actions", &BatchedSimulator::getNumActions, R"(todo)")
      .def("set_camera", &BatchedSimulator::setCamera, R"(todo)")
      ...
      .def("wait_step_physics_or_reset",
           &BatchedSimulator::waitStepPhysicsOrReset, R"(todo)")
      ...
      .def(
          ...
          R"(todo)")
      .def("get_recent_stats_and_reset",
           &BatchedSimulator::getRecentStatsAndReset, R"(todo)");
}
