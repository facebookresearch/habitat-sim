...
class BulletBase {
 public:
   ...
   * esp::physics::RigidObjectType::SCENE. See @ref btCompoundShape::getMargin.
   ...
   * esp::physics::RigidObjectType::SCENE. See @ref btCompoundShape::setMargin.
 ...
 protected:
  ...
  /** @brief Static data: All components of a @ref esp::physics::RigidObjectType::SCENE are
