...
==================================================
  ...
  std::vector<Magnum::Vector3> agentLocs_{
      {0, 1, -1.2},    {0, 1, -1.3},    {0, 1, -1.4},    {0, 1, -1.5},
      {0, 1, -1.6},    {0, 1, -1.7},    {0, 1, -1.8},    {0, 1, -1.9},
      {0, 1, -2},      {0, 1, -2.1},    {0, 1, -2.2},    {0, 1, -2.3},
      {0, 1, -2.4},    {-0.1, 1, -2.4}, {-0.2, 1, -2.4}, {-0.3, 1, -2.4},
      {-0.4, 1, -2.4}, {-0.5, 1, -2.4}, {-0.6, 1, -2.4}, {-0.7, 1, -2.4},
      {-0.8, 1, -2.4}, {-0.9, 1, -2.4}, {-1, 1, -2.4},   {-1.1, 1, -2.4},
      {-1.2, 1, -2.4}, {-1.2, 1, -2.5}, {-1.2, 1, -2.6}, {-1.2, 1, -2.7},
      {-1.3, 1, -2.7}, {-1.4, 1, -2.7}, {-1.5, 1, -2.7}, {-1.6, 1, -2.7},
      {-1.7, 1, -2.7}, {-1.8, 1, -2.7}, {-1.9, 1, -2.7}, {-2, 1, -2.7},
      {-2.1, 1, -2.7}, {-2.2, 1, -2.7}, {-2.3, 1, -2.7}, {-2.4, 1, -2.7},
      {-2.5, 1, -2.7}, {-2.6, 1, -2.7}, {-2.7, 1, -2.7}, {-2.8, 1, -2.7},
      {-2.9, 1, -2.7}, {-3, 1, -2.7},   {-3.1, 1, -2.7}, {-3.2, 1, -2.7},
      {-3.3, 1, -2.7}, {-3.4, 1, -2.7}, {-3.4, 1, -2.8}, {-3.4, 1, -2.9},
      {-3.5, 1, -2.9}, {-3.5, 1, -3},   {-3.5, 1, -3.1}, {-3.6, 1, -3.1},
      {-3.6, 1, -3.2}, {-3.7, 1, -3.2}, {-3.7, 1, -3.3}, {-3.8, 1, -3.3},
      {-3.8, 1, -3.4}, {-3.9, 1, -3.4}, {-3.9, 1, -3.5}, {-4, 1, -3.5},
      {-4, 1, -3.6},   {-4.1, 1, -3.6}, {-4.1, 1, -3.7}, {-4.2, 1, -3.7},
      {-4.2, 1, -3.8}, {-4.3, 1, -3.8}, {-4.3, 1, -3.9}, {-4.3, 1, -4},
      {-4.3, 1, -4.1}, {-4.3, 1, -4.2}, {-4.3, 1, -4.3}, {-4.3, 1, -4.4},
      {-4.4, 1, -4.4}, {-4.5, 1, -4.4}, {-4.6, 1, -4.4}};
