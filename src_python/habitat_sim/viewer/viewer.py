...
class HabitatSimInteractiveViewer(Application):
    ...
    def __init__(self, sim_settings: Dict[str, Any]) -> None:
        ...
        camera_resolution: Tuple[int, int] = (
            int(surface_size[0] / grid_size[0]),
            int(surface_size[1] / grid_size[1]),
        )
        ...
        if (
            ...
            and not self.sim.pathfinder.is_loaded
    ...
    def move_and_look(self, repetitions: int) -> None:
        ...
        press: Dict[Application.KeyEvent.Key, bool] = self.pressed
        act: Dict[Application.KeyEvent.Key, str] = self.key_to_action
...
if __name__ == "__main__":
    ...
    sim_settings["font_path"] = os.path.join(data_path, "fonts/ProggyClean.ttf")
