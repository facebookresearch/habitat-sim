...
def display_topdown_map(
    ...
    :param topdown_map: the topdown map object generated by PathFinder.get_topdown_view. Numpy 2d boolean array.
    :param plot_title: (optional) title of the plot.
    :param save_file: (optional) filepath to save plot.
    ...
    :param marker_alpha: alpha value for the plot marker overlay.
    :param scale: size (inches) of largest plot dimension.
    """
    ...
    scale_factor = scale / max(size)
    plt.figure(figsize=(size[0] * scale_factor, size[1] * scale_factor))
