...
:gh:`An example of an appropriately configured Scene Dataset Configuration file can be found below <facebookresearch/habitat-sim/blob/main/data/test_assets/dataset_tests/dataset_1/test_dataset_1.scene_dataset_config.json>`:

.. include:: ../../../data/test_assets/dataset_tests/dataset_1/test_dataset_1.scene_dataset_config.json
    :code: json
