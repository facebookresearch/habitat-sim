...
mp3d_test_base = osp.join(base_dir, "data/scene_datasets/mp3d_test")
if test_all and osp.exists(mp3d_test_base):
    test_navmeshes += glob.glob(f"{mp3d_test_base}/*/*.navmesh")
