...
def test_unproject(zfar):
    ...
    with habitat_sim.Simulator(hab_cfg) as sim:
        ...
        # setup camera
        far_plane = sim.sensors["depth_sensor"].sensor_object.far_plane_dist
        assert zfar == far_plane
        render_camera = sim.sensors["color_sensor"].sensor_object.render_camera
        depth_camera = sim.sensors["depth_sensor"].sensor_object.render_camera
