...
class FollowCam:
    ...
    def update_state(self):
        ...
        """
        self.target_pos = self.humanoid.base_pos + mn.Vector3(1.5, 2.0, 0.55)
...
class HabitatSimInteractiveViewer(Application):
    ...
    def __init__(self, sim_settings: Dict[str, Any]) -> None:
        ...
        self.humanoid_seq_motions_staged = {
            "data/humanoids/humanoid_data/mdm_data/clean.pkl": (
                mn.Vector3(-9.54835, 0.161142, -1.0266),
                0,
                mn.Vector3(
                    [-11.335000038146973, 0.1611420065164566, -2.3755500316619873]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, -0.9396920204162598, 0.0]), 0.34202098846435547
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.08715520054101944, 0.0, 0.0]), 0.9961950182914734
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/cleanfloor.pkl": (
                mn.Vector3(-4.82592, 0.161142, -3.80573),
                5.299999999999997,
                mn.Vector3(
                    [-6.347925186157227, 0.1611417979001999, -2.916027784347534]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, 0.5150385499000549, 0.0]), -0.8571670651435852
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.1650473177433014, 0.0, 0.0]), 0.9862856864929199
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/clean_walk.pkl": (
                mn.Vector3(-5.34183, 0.161142, -17.76),
                9.499999999999982,
                mn.Vector3(
                    [-3.6360042095184326, 0.1611417979001999, -15.998992919921875]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, -0.5735772252082825, 0.0]), -0.8191514611244202
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.1822354793548584, 0.0, 0.0]), 0.9832549095153809
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/crawl.pkl": (
                mn.Vector3(-17.1917, 0.161142, -1.90025),
                1.0999999999999999,
                mn.Vector3(
                    [-14.182170867919922, 0.1611417979001999, -1.8477216958999634]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, -0.7193410992622375, 0.0]), -0.694657027721405
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.13052594661712646, 0.0, 0.0]), 0.9914448857307434
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/hand motion.pkl": (
                mn.Vector3(-10.5128, 0.161142, 3.80101),
                0,
                mn.Vector3([-9.278878211975098, 0.1611417979001999, 4.46745491027832]),
                mn.Quaternion(
                    mn.Vector3([0.0, 0.5446397066116333, 0.0]), 0.8386701941490173
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.061048295348882675, 0.0, 0.0]), 0.9981348514556885
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/knock.pkl": (
                mn.Vector3(-11.1433, 0.161142, -9.59362),
                4.6,
                mn.Vector3(
                    [-10.873861312866211, 0.1611417979001999, -10.398992538452148]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, -0.8788170218467712, 0.0]), -0.47715890407562256
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.19080893695354462, 0.0, 0.0]), 0.9816272258758545
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/pick.pkl": (
                mn.Vector3(-11.0348, 0.200322, -3.53744),
                3.4000000000000017,
                mn.Vector3(
                    [-9.278177261352539, 0.23594526946544647, -3.3393139839172363]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, 0.4226190745830536, 0.0]), 0.9063074588775635
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.20791155099868774, 0.0, 0.0]), 0.9781476259231567
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/pour water.pkl": (
                mn.Vector3(-1.01277, 0.161142, -1.72334),
                9.99999999999998,
                mn.Vector3(
                    [-1.0766794681549072, 0.1611417979001999, -3.1317100524902344]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, -0.9969173073768616, 0.0]), 0.07845987379550934
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.23344509303569794, 0.0, 0.0]), 0.9723700284957886
                ),
            ),
            "data/humanoids/humanoid_data/mdm_data/sit.pkl": (
                mn.Vector3(-8.28614, 0.161142, 0.451019),
                6.8999999999999915,
                mn.Vector3(
                    [-9.003680229187012, 0.1611417979001999, 0.7684634923934937]
                ),
                mn.Quaternion(
                    mn.Vector3([0.0, 0.8910062313079834, 0.0]), -0.4539911150932312
                ),
                mn.Vector3([0.0, 1.5, 0.0]),
                mn.Quaternion(
                    mn.Vector3([-0.25881877541542053, 0.0, 0.0]), 0.965925931930542
                ),
            ),
        }
    ...
    def init_humanoid(self, model: Tuple[str, str], controller=SeqPoseController):
        """
        ...
        seq_state = self.humanoid_seq_motions_staged[model[1]]
        self.humanoid.base_pos = seq_state[0]
        self.additional_rot = seq_state[1]
        self.humanoid.sim_obj.rotation = mn.Quaternion.rotation(
            mn.Rad(self.additional_rot), mn.Vector3(0, 1, 0)
        )
        ...
        self.default_agent.scene_node.translation = seq_state[2]
        self.default_agent.scene_node.rotation = seq_state[3]
    ...
    def key_press_event(self, event: Application.KeyEvent) -> None:
        ...
        if key == pressed.ESC:
            ...
            print(
                f"Agent State: {self.default_agent.scene_node.translation} {self.default_agent.scene_node.rotation}"
            )
            print(
                f"Camera State: {self.render_camera.node.translation} {self.render_camera.node.rotation}"
            )
            print(
                f"Paste: mn.Vector3({list(self.default_agent.scene_node.translation)}), mn.Quaternion(mn.Vector3({list(self.default_agent.scene_node.rotation.vector)}), {self.default_agent.scene_node.rotation.scalar}), mn.Vector3({list(self.render_camera.node.translation)}), mn.Quaternion(mn.Vector3({list(self.render_camera.node.rotation.vector)}), {self.render_camera.node.rotation.scalar})),"
            )
            # if shift_pressed:
            ...
            b_pos = self.humanoid.base_pos
            self.humanoid.reset()
            # self.humanoid.sim_obj.rotation = self.humanoid.sim_obj.rotation.__mul__(mn.Quaternion.rotation(mn.Rad(self.additional_rot), mn.Vector3(0,1,0)))
            self.humanoid.sim_obj.rotation = mn.Quaternion.rotation(
                mn.Rad(self.additional_rot), mn.Vector3(0, 1, 0)
            )
            self.humanoid.base_pos = b_pos
            if shift_pressed:
                # pass
                self.additional_rot += 0.1
            else:
                self.humanoid.base_pos = self.default_agent.scene_node.translation
            print("Humanoid State:")
            # self.humanoid_controller.reset(self.humanoid.base_transformation)
            self.humanoid_controller = SeqPoseController(
                self.humanoid_controller.walk_pose_path
            )
            self.humanoid_controller.reset(self.humanoid.base_transformation)
            print(f"{self.humanoid.base_pos} {self.additional_rot}")
