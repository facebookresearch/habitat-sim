...
def main():
    ...
    # without calling renderer.acquire_gl_context() as by default getting the sensor
    # observations transfers the OpenGL context back

    backend_cfg = habitat_sim.SimulatorConfiguration()
    backend_cfg.scene_id = "data/scene_datasets/habitat-test-scenes/apartment_1.glb"
    backend_cfg.enable_physics = True
    # Enabling this here for fun
    backend_cfg.leave_context_with_background_renderer = True
    ...
    # Now you'd need to do
    #     sim.renderer.acquire_gl_context()
    # before adding or deleting objects
