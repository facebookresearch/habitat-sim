...
def simulate(sim, dt=1.0, get_frames=True):
    # simulate dt seconds to the nearest fixed timestep
...
def main(make_video=True, show_video=True):
    ...
    target_direction = sim.get_translation(box_ids[1]) - sim.get_translation(sphere_id)
